 ...
 */
 module App = {
  ...
  let make = () => {
     ...
     * placeholders inside the curly braces (e.g., `ahrefs`) will be replaced 
    ...
    let configuration =
      Cma_configuration.Configuration.make(
        ~name="ahrefs",
        ~directory="/Users/scott/Development/technical-exercises/ahrefs/ahrefs",
        ~node_package_manager=Npm,
        ~bundler=Vite,
        ~is_react_app=true,
        ~initialize_git=true,
        ~initialize_npm=false,
